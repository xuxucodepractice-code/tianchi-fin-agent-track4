...
| E014 | E013 candidate build locality audit | immutable E013 PASS + v2s1 | 精确父哈希和原生 12/12 audit 处理单一外部 lineage locality；零 API | 198 tests；builder/source/parent/slots 已冻结 | 0 API tokens | 不提交 | BUILD_FROZEN / AUTHORIZED_TO_BUILD_ONCE |
