...
| E009 | Multi document-order binding | E008 reference-free technical base | 显式绑定题面第一/第二份文档与 doc_ids 顺序 | development 8/13→10/13；父正确题零回退 | +2,392 | 不提交 | DEVELOPMENT_GATE_PASS / PROSPECTIVE_PREREGISTRATION_PENDING |
