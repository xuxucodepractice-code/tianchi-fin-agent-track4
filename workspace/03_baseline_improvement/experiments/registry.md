...
| E008 | Multi trace-bound provenance | E006 treatment retrieval | treatment 取消模型自报 evidence_refs，以完整 Trace evidence pack 作为 provenance | control 13 题完成，paired 待 treatment | control 180,727 | 不提交 | DEVELOPMENT_CONTROL_PASS / TREATMENT_AUTHORIZED |
