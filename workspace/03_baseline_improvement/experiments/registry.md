...
| E007R1 | Multi evidence reference integrity TLS-fixed rerun | E007 设计、全新治理身份 | 仅 `[证据N]`+整数引用改为 `[EVN]`+严格字符串引用；CA bundle 是冻结传输环境 | 待测 | 待测 | 不提交 | PREREGISTERED / DEVELOPMENT_NOT_RUN |
