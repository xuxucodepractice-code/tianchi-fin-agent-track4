...
| E014 | E013 candidate build locality audit | immutable E013 PASS + v2s1 | 精确父哈希和原生 12/12 audit 处理单一外部 lineage locality；零 API | 候选 validator PASS、专属 11/11；投影 73.1372 > 65.0912 | build 0 API；候选 1,171,501 tokens | 待主理人提交 | CANDIDATE_FROZEN / READY_FOR_USER_SUBMISSION |
