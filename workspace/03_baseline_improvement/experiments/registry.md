...
| E009 | Multi document-order binding | E008 reference-free technical base | 显式绑定题面第一/第二份文档与 doc_ids 顺序 | development 8/13→10/13；父正确题零回退；全新 3×5 holdout 因 insurance 仅余 1 题不可行 | +2,392 | 不提交 | DEVELOPMENT_GATE_PASS / PROSPECTIVE_SELECTION_INFEASIBLE_UNDER_FROZEN_QUOTA |
