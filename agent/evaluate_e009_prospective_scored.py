"""Score the frozen E009 primary arm only after label-free churn is frozen."""
...
def main() -> int:
    ...
    if (
        labels.get("schema_version") != "e009-prospective-labels/v1"
        or labels.get("experiment_id") != "E009"
    ...
    report = {
        "schema_version": "e009-prospective-scored-result/v1",
        "experiment_id": "E009",
        "pair_id": PAIR_ID,
